"""Data and helper function for the "Review" test"""
...
def create_review_customer_objects(reviewer, range_stop = 12):
    """creates reviews where the business user changes and the reviewer remains the same"""
...
def create_review_business_objects(range_stop):
    """Creates reviews where the reviewer changes and the business user remains the same"""
...
def create_double_review_objects():
    """Creates a second review by a reviewer for a business profile"""
